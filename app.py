...
def page_eval():
    ...
    # *** QUITAMOS la sección “Detalle y explicación” (select, gráfico y visor) ***
    # (Se elimina por solicitud: no mostrar esos campos aquí)
            ...
            if st.button("Ejecutar evaluación LLM", disabled=btn_disabled, key="btn_llm_run"):
                if not llm_files:
                    ...
                    try:
                        ...
                        ss.eval_llm_busy = False; _render_loader(False); st.experimental_rerun()
