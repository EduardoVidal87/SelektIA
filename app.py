...
# (NUEVO) Bytes de un PDF de ejemplo mínimo para la previsualización (CORREGIDO)
DUMMY_PDF_BYTES = base64.b64decode(
    b"JVBERi0xLjEKJSAxIDAgb2JqPDwvVHlwZSAvQ2F0YWxvZyAvUGFnZXMgMiAwIFI+PgplbmRvYm"
    b"oKMiAwIG9iago8PC9UeXBlIC9QYWdlcyAvS2lkcyBbMyAwIFJdIC9Db3VudCAxPj4KZW5kb2Jq"
    b"CjMgMCBvYmoKPDwvVHlwZSAvUGFnZSAvUGFyZW50IDIgMCBSIC9NZWRpYUJveCBbMCAwIDMwMC"
    b"AxNDBdIC9Db250ZW50cyA0IDAgUiAvUmVzb3VyY2VzPDwvUHJvY1ZldCBbL1BERiAvVGV4dF0g"
    b"L0ZvbnQ8PC9GMSA1IDAgUj4+Pj4+CmVuZG9iago0IDAgb2JqPDwvTGVuZ3RoIDc3Pj5zdHJlYW0K"
    b"QVQKL1RleHQgYmVnaW4KL0YxIDEyIFRmCjEwIDExMCBUZAooQ1YgZGUgRXF1aXBbyApIFRqIAox"
    b"MCA5MCBUZChEb2N1bWVudG8gZGUgcHJ1ZWJhKVRqIAplbmR0ZXh0CmVuZHN0cmVhbQplbmRvYmoK"
    b"NSAwIG9iago8PC9UeXBlIC9Gb250IC9TdWJ0eXBlIC9UeXBlMSAvQmFzZUZvbnQgL0hlbHZldGlj"
    b"YT4+CmVuZG9iagp4cmVmCjAgNgowMDAwMDAwMDAwIDY1NTM1IGYgCjAwMDAwMDAwMTAgMDAwMDAg"
    b"biAKMDAwMDAwMDA2MSAwMDAwMCBuIAowMDAwMDAwMTEzIDAwMDAwIG4gCjAwMDAwMDAyOTggMDAw"
    b"MDAgbiAKMDAwMDAwMDQzMiAwMDAwMCBuIAp0cmFpbGVyPDwvU2l6ZSA2IC9Sb290IDEgMCBSPj4K"
    b"c3RhcnR4cmVmCjQ5NAolJUVPRgo="
)
